...
class ActionName(str, Enum):
    ...
    FIND_FILES_BY_TYPE = "FIND_FILES_BY_TYPE"
    LIST_RECENT_FILES = "LIST_RECENT_FILES"
    OPEN_LATEST_FILE = "OPEN_LATEST_FILE"
...
ACTION_WHITELIST: dict[str, ActionSpec] = {
    ...
    ActionName.LIST_INSTALLED_APPS: ActionSpec(ActionName.LIST_INSTALLED_APPS, (), ("query",), SecurityLevel.SAFE,
        "List applications installed on this computer. Use for 'what apps do I have', 'list installed programs'."),
    ActionName.FIND_APP: ActionSpec(ActionName.FIND_APP, ("app",), (), SecurityLevel.SAFE,
        "Check whether a specific application is installed, e.g. 'do I have Spotify?'."),

    ActionName.OPEN_FOLDER: ActionSpec(ActionName.OPEN_FOLDER, ("path",), ("context",), SecurityLevel.SAFE,
        "Open a safe-root folder."),
    ActionName.OPEN_FILE: ActionSpec(ActionName.OPEN_FILE, ("path",), ("context",), SecurityLevel.SAFE,
    ...
    ActionName.FIND_FILES_BY_TYPE: ActionSpec(ActionName.FIND_FILES_BY_TYPE, (), ("keyword", "extension", "path"), SecurityLevel.SAFE,
        "Find files by extension/type and an optional keyword (e.g. 'my kubernetes yaml files')."),
    ActionName.LIST_RECENT_FILES: ActionSpec(ActionName.LIST_RECENT_FILES, (), ("path", "hours"), SecurityLevel.SAFE,
        "List files modified within a recent time window (e.g. 'today')."),
    ActionName.OPEN_LATEST_FILE: ActionSpec(ActionName.OPEN_LATEST_FILE, ("path",), (), SecurityLevel.SAFE,
        "Open the most recently modified file in a folder (e.g. the latest screenshot)."),
    ...
    ActionName.OPEN_WEBSITE: ActionSpec(ActionName.OPEN_WEBSITE, ("site",), ("browser",), SecurityLevel.SAFE,
        "Open a website or safe URL."),
    ActionName.WEB_SEARCH: ActionSpec(ActionName.WEB_SEARCH, ("query",), ("browser",), SecurityLevel.SAFE,
        "Search the web."),
    ...
    ActionName.CLIPBOARD_READ: ActionSpec(ActionName.CLIPBOARD_READ, (), (), SecurityLevel.SAFE,
        "Read what is currently on the clipboard."),
    ActionName.CLIPBOARD_WRITE: ActionSpec(ActionName.CLIPBOARD_WRITE, ("text",), (), SecurityLevel.SAFE,
        "Copy text to the clipboard."),
    ActionName.HELP: ActionSpec(ActionName.HELP, (), (), SecurityLevel.SAFE,
        "Explain what AURA can do."),
    ...
    ActionName.ACTIVITY_SUMMARY: ActionSpec(ActionName.ACTIVITY_SUMMARY, (), ("period",), SecurityLevel.SAFE,
        "Summarize what AURA did today or yesterday."),
}
